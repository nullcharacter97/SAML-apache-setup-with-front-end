...
$config = [
    ...
    'default-sp' => [
        ...
        'idp' => 'https://idp.sust.com/simplesaml/saml2/idp/metadata.php',
    ...
    */
    ...
    'example-userpass' => [
        ...
        'student:1234' => [
            'uid' => ['student@mail.sustmail.com'],
            'eduPersonAffiliation' => ['member', 'student'],
        ],
	'admin:1234' => [
            'uid' => ['admin@mail.sustmail.com'],
            'eduPersonAffiliation' => ['member', 'admin'],
        ],
        'employee:1234' => [
            'uid' => ['employee@mail.sustmail.com'],
            'eduPersonAffiliation' => ['member', 'employee'],
        ],
	'manager:1234' => [
            'uid' => ['manager@mail.sustmail.com'],
            'eduPersonAffiliation' => ['member', 'manager'],
        ],
